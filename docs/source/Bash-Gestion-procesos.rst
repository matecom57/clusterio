...
Thinkiti edited this page Jan 22, 2019 · 4 revisions
top
...
Son de especial interes el arreglo por USER, CPU% y MEM%.
Matar procesos

Bash tiene diversas formas para terminar comandos y procesos en ejecución, revise la entrada para terminar un proceso.
