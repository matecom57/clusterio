...
La wiki del C-13 en la actualidad esta albergada como una pagina wiki de gitHub como parte del repositorio: `c13inb.github.io <https://github.com/c13inb/c13inb.github.io>`_ . Este repositorio es una pagina web hecha por Raul para el lab sin mucho uso.
...
Para ello primero necesitas ser colaborador del siguiente repositorio: `c13inb/c13inb.github.io <https://github.com/c13inb/c13inb.github.io>`_
Para esto deberás contactar al Doctor Concha y darle tu usuario de github.

Ya siendo colaborador puedes modificar la wiki con las opciones de manera web o local como se describe `por aca: <https://docs.github.com/en/github/building-a-strong-community/adding-or-editing-wiki-pages>`_
