DWMRI: Registro
Luis Concha edited this page on Feb 16 · 2 revisions
⚠️ OJO, en 2024 ya tenemos una mejor herramienta, inb_synthreg.sh.
...
Para este ejemplo, vamos a asumir algunas cosas: $t1 es mi imagen pesada a T1 (a la que ya le hicimos brain_extraction_tool_bet ) , $adc es mi mapa de ADC derivado de mis DWIs (habiendo usado bet).
