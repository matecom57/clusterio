...
Algunos datos sobre el resonador:
    ...
    El resonador tiene un magneto Pharmascan, sin embargo toda la electrónica y los gradientes son de un Biospec. Por lo tanto, el resonador es de facto un Biospec.
...
La transferencia de los datos se puede realizar en varios formatos:
    ...
    Formato NIFTI: Obten primero tus datos en DICOM y posteriormente conviértelos en tu máquina usando mrconvert de Mrtrix3, o dcm2niix.
...
Paso numero uno es cargar el modulo de Bruker (gracias a Ricardo Rios que nos hizo la vida mas facil al crear los modulos, si aun no te familiarizas con ellos, da click aquí y aprende mas a como usarlos.
...
Una vez que conviertes tus imágenes, estas listo para el siguiente paso que es procesarlas de acuerdo al tipo de estudio. Aprende más acerca de como procesar tus imágenes en esta entrada.
