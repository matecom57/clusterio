...
.. warning::
	 Todo usuario del cluster Don Clusterio debe estar inscrito en la Red Lanirem en el canal `#don_clusterio <https://chat-lanirem.lavis.unam.mx/channel/don_clusterio>`_. No hacerlo implica la desactivación de la cuenta.
