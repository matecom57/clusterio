...
Comprimir los archivos `DICOM <http://es.wikipedia.org/wiki/DICOM>`_, reduce dramaticamente el uso de espacio de disco, por lo que es una practica recomendable. Además depende de una instrucción sencilla.  
