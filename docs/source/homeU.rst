...
En distribuciones modernas de linux (como ubuntu), la carpeta de configuración se define dentro de las variables de entorno que comienzan con $XDG_. Si te gustaría saber más al respecto, lee las especificaciones aquí.

Usa el script inb_config_XDG.sh para mover tus carpetas de configuración a un disco duro local.

ℹ️ CHECA AQUÍ UN TUTORIAL 😄
